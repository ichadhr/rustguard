...
use crate::routes::{api, health, profile, register, policies, permissions, auth, graphql, system};
    ...
    let merged_router = {
        ...
        let health_routes = health::routes()
            .layer(ServiceBuilder::new().layer(
                middleware::from_fn_with_state(rate_limit_state.clone(), rate_limit_general),
            ))
